  ...
  return (
	<>
	  <div className="container-fluid mt-4">
		...
		<ul className="ml-n3">
		  <li className="mb-2">We are working on <span className="font-weight-bold">more <a href="https://bfwiki.tellefsen.net/index.php/DevelopingPlugins">plugins</a></span>, which requires some C, gtk or python knowledge</li>
		  <li className="mb-2">Writing the <span className="font-weight-bold">manual</span> in our wiki</li>
		  <li className="mb-2"><span className="font-weight-bold">Translations</span> - several languages are out of date, see the <a href="http://bfwiki.tellefsen.net/index.php/Translations">WiKi</a></li>
		...
		<hr />
		<p>Bluefish uses SVN (Subversion) hosted by  <a href="http://sourceforge.net/projects/bluefish/">Sourceforge</a> to manage the code. You can <a href="https://sourceforge.net/p/bluefish/code/HEAD/tree/trunk/bluefish/">browse the repository</a> on-line.
		...
		<p className="mt-3">For more information see the wiki page <a href="http://bfwiki.tellefsen.net/index.php/Compiling_Bluefish_from_source">Compiling Bluefish from source code</a>.</p>
		<h4 className="pt-3">Bleeding edge Debian/Ubuntu packages</h4>
		<hr />
		<p>There is a Bluefish-snapshots PPA at <a href="https://launchpad.net/~klaus-vormweg/+archive/ubuntu/bluefish-snapshots">https://launchpad.net/~klaus-vormweg/+archive/ubuntu/bluefish-snapshots</a>. Use these at your own risk, the software in these packages is still under development!</p>

		<p>Debian/Ubuntu packages can also be created from the subversion repository.  <span className="font-weight-bold">These are NOT official packages and should only be distributed as "bluefish-unstable". Only use the script and the created packages if you follow the development. For "normal" users, official packages are <Link href="/downloads" className="text-primary">available here</Link></span>.</p>
		<div className="bg-light px-sm-2">
		  <p className="text-monospace mb-1 text-break">svn co svn://svn.code.sf.net/p/bluefish/code/trunk/bluefish</p>
		  <p className="text-monospace mb-1">cd bluefish</p>
		...
		<ul className="ml-n3">
		  <li className="mb-2"><a href="http://olivier.sessink.nl/directoryassistant/">Directory Assistant</a> - an LDAP addressbook frontend</li>
		  <li className="mb-2"><a href="https://olivier.sessink.nl/jailkit/">Jailkit</a> - a set of utilities to limit user accounts</li>
		  <li className="mb-2"><a href="https://olivier.sessink.nl/scannedonly/">Scannedonly</a> - a scalable high performance Samba anti virus module</li>
		  <li className="mb-2"><a href="http://rro.sourceforge.net/">Risk Reduction Overview</a> or Risico Reductie Overzicht - a risk management tool</li>
		  <p>Daniel Leidert is also known for:</p>
		  <li className="mb-2"><a href="https://qa.debian.org/developer.php?login=daniel.leidert@wgdd.de">lots of Debian packages</a>, and <a href="https://bugs.launchpad.net/~dleidert">Ubuntu packages</a></li>
		</ul>
	  </div>
	</>
  )
